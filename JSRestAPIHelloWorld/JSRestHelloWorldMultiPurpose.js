...
/*
 * var apm = require('elastic-apm-node').start({ // Set required app name
 * (allowed characters: a-z, A-Z, 0-9, -, _, and space) appName:
 * 'JSHelloWorldMultiPurpose', // Use if APM Server requires a token
 * secretToken: '', // Set custom APM Server URL (default:
 * http://localhost:8200) serverUrl: 'http://localhost:8200' })
 */
...
app.get('/Download:file(*)', function(req, res, next){ // this routes all types
	// of file
